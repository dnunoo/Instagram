...
//  Instagram
//
//  Created by Deaz Nunoo on 10/11/22.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let parseConfig = ParseClientConfiguration {
            $0.applicationId = "RMjIYidNnLaPXVBwVu2G9WUxKeWaQFj2BxMFpttV" // <- UPDATE
            $0.clientKey = "PVo08PQl1h6LBzZs0TsOIqbVuUZDrLZYMnZ0s7nH" // <- UPDATE
